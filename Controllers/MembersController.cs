...
namespace LibraryManagementSystem.Controllers
{
    public class MembersController : Controller
    {
        ...
        {
            var mber = _context.Members.Where(x=> x.Email == mUser.Email && x.Password == x.Password).FirstOrDefault();
            if(mber != null)
            {
                HttpContext.Session.SetString("UserSession", mber.Email);
        ...
        public IActionResult Dashboard()
        {
            ...
            {
                ViewBag.Membersession = HttpContext.Session.GetString("UserSession").ToString();
            }
            else
            {
        ...
        public async Task<IActionResult> Create([Bind("MemberId,Name,Email,Address,MembershipDate,Status,Password")] Member member)
        {
            if (ModelState.IsValid)
            {
                _context.Add(member);
